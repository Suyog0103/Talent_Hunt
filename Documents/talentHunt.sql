...
insert into artist values("piyush11@gmail.com", "xyz", "male", "magitian","piyush","12345", 6969);
insert into artist values("farjad@gmail.com", "xyz", "male", "instrumentalist","farjad","12345", 6969);
select * from artist;
...
insert into adate_avail values(default, 18000, "4-4-2023",null,"piyush11@gmail.com");
insert into adate_avail values(default, 18000, "4-4-2023",null,"farjad@gmail.com");
...
SELECT t1.artist_email, t1.artist_name, t1.artist_genre, t2.booked_date, t2.order_price FROM artist t1 JOIN order1 t2 ON t1.artist_email = t2.artist_email where t2.email="ss@gmail.com" && t2.book=0 ;
...
UPDATE order1 SET book = 1 WHERE artist_email = 'tanmay@gmail.com';
