...
public class OrderServiceImpl implements OrderService {
	...
	public void confirmbooking(String artistemail)
	{
		oDao.confirmbooking(artistemail);
	}
	
	public List<Order1> getbookedartistByUserEmail(String email)
	{
		return oDao.getbookedartistByUserEmail(email);
	}
