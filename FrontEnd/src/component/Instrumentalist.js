...
import backgroundImage from '../singer-img/aditya-chinchure-ZhQCZjr9fHo-unsplash.jpg'; 
...
class Instrumentalist extends Component {
  constructor(props) {
    super(props);
    this.state = {
      singerarr: [],
  ...
  render() {
    return (
      ...
      >
        ...
        >
          <h2 style={{ color: '#333', textAlign: 'center' }}>Instrumentalist List</h2>
